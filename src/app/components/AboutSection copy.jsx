...
const AboutSection = () => {
	...
	return (
		<section id="aboutSection">
			<div
				id="about"
				className="pt-12 md:pt-16 bg-[#bebebe] md:flex md:flex-row sm:flex-col items-top items-center justify-center"
			>
				<div className="md:grid md:grid-cols-1">
					...
					<div
						className="lg:px-80  drop-shadow-lg 
							w-[400px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[650px] relative  
							"
					>
						<Image
							src={"/images/khoi.jpg"}
